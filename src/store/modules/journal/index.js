...
const state = {
  searchFields: {
    ...
    extraIds: ["journal_name", "journal_short"],
  },
  headers: [
    {
      value: "id",
    ...
    {
      value: "former_journal__id",
      text: "journal.former_journal__id",
      show: false,
    },
    {
      value: "former_journal__journal_name",
      text: "journal.former_journal__journal_name",
      show: false,
    },
    {
      value: "following_journal__id",
      text: "journal.following_journal__id",
      show: false,
    },
    {
      value: "following_journal__journal_name",

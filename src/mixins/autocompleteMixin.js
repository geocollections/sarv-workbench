...
const autocompleteMixin = {
  computed: {
    ...
    taxonCharacterLabel() {
      return this.$i18n.locale === "ee" ? "character" : "character_en";
    },
    taxonCharacterStateLabel() {
  ...
  methods: {
    ...
    autocompleteSampleTaxonSearch(value) {
      this.$_autocompleteMixin_search(value, "taxon", "sample_taxon");
    },
    autocompleteTaxonParentSearch(value) {
      this.$_autocompleteMixin_search(value, "taxon", "parent");
    },
    autocompleteTaxonCharacterSearch(value) {
      this.$_autocompleteMixin_search(value, "taxon_character", "character");
    },
    autocompleteTaxonCharacterStateSearch(value) {
      this.$_autocompleteMixin_search(
        value,
...
function buildAutocompleteQuery(type, val, currentUser, groupByField) {
  ...
  switch (type) {
    ...
    case "taxon_character":
      return `taxon_character/?multi_search=value:${value};fields:character,character_en;lookuptype:icontains&fields=id,character,character_en`;
    case "taxon_character_state":
      return `taxon_character_state/?multi_search=value:${value};fields:character_state,character_state_en;lookuptype:icontains&fields=id,character_state,character_state_en`;
    case "fossil_group":

<template>
  <div
    ...
    :class="{ active: activeTab === 'preparation' }"
    role="tabpanel"
  >
          ...
          <tbody>
            ...
            >
              ...
              <td v-if="entity.editMode">
                <b-form-input
                  v-model="entity.new.preparation_number"
                  type="text"
                />
              </td>
              <td v-if="entity.editMode">
            ...
            <tr class="related-input-data">
              <td>
                <b-form-input
                  v-model="relatedData.insert.preparation.preparation_number"
                  type="text"
                />
              </td>
              <td>
                <vue-multiselect
                  v-model="relatedData.insert.preparation.taxon"
                  id="taxon_insert"
                  :options="autocomplete.fossil_group"
                  track-by="id"
                  label="taxon"
              ...
              <td>
                <vue-multiselect
                  v-model="relatedData.insert.preparation.storage"
                  id="storage_insert"
                  label="location"
                  track-by="id"
                  :placeholder="$t('add.inputs.autocomplete')"
              ...
              <td>
                <b-form-input
                  v-model="relatedData.insert.preparation.remarks"
                  type="text"
                />
              </td>
              ...
              <td class="text-center">
                <b-form-checkbox
                  v-model="relatedData.insert.preparation.is_private"
                  :value="true"
                  :unchecked-value="false"
                />
              </td>
  ...
  methods: {
    customAnalysisLabel(item) {
      return this.$i18n.locale === "ee"
        ? `${item.id} (${item.analysis_method__analysis_method})`
        : `${item.id} (${item.analysis_method__method_en})`;
    }
  }
};
</script>

              ...
              <v-row>
                ...
                <v-col cols="12" md="6" class="pa-1">
                  <autocomplete-wrapper
                    ...
                    :color="bodyActiveColor"
                    :items="autocomplete.agent_identified"
                    :loading="autocomplete.loaders.agent_identified"
                    item-text="agent"
...
export default {
  ...
  methods: {
    ...
    setItemFields(item) {
      ...
      if (item.agent_identified) {
        this.item.agent_identified = item.agent_identified;
        this.autocomplete.agent_identified.push(this.item.agent_identified);
      }

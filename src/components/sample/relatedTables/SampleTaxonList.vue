<template>
  <div
    ...
    :class="{ active: activeTab === 'taxon_list' }"
    role="tabpanel"
  >
    <div class="col-sm-12" v-if="activeTab === 'taxon_list'">
      <div class="table-responsive-sm">
        <table class="table table-hover table-bordered related-table">
          ...
          <tbody>
            <tr
              v-for="(entity, index) in relatedData.taxon_list"
              :key="entity.id"
              :class="{
            ...
            >
              ...
              <td v-if="!entity.editMode">
                {{ entity.agent_identified__agent }}
              </td>
              ...
              <td v-if="entity.editMode">
                <vue-multiselect
                  v-model="entity.new.agent_identified"
                  id="agent_identified"
                  label="agent"
                  track-by="id"
                  :placeholder="$t('add.inputs.autocomplete')"
              ...
              <td v-if="entity.editMode">
                <vue-multiselect
                  v-model="entity.new.preparation"
                  id="preparation"
            ...
            <tr class="related-input-data">
              <td>
                <vue-multiselect
                  v-model="relatedData.insert.taxon_list.taxon"
                  id="taxon_insert"
                  label="taxon"
                  track-by="id"
                  :placeholder="$t('add.inputs.autocomplete')"
              ...
              <td>
                <b-form-input
                  v-model="relatedData.insert.taxon_list.name"
                  type="text"
                />
              </td>
              ...
              <td>
                <b-form-input
                  v-model="relatedData.insert.taxon_list.frequency"
                  type="number"
                />
              </td>
              ...
              <td>
                <vue-multiselect
                  v-model="relatedData.insert.taxon_list.agent_identified"
              ...
              <td class="text-center">
                <b-form-checkbox
                  v-model="relatedData.insert.taxon_list.extra"
                  :value="true"
                  :unchecked-value="false"
                />
              </td>
              ...
              <td>
                <vue-multiselect
                  v-model="relatedData.insert.taxon_list.preparation"
              ...
              <td class="text-center">
                <b-form-checkbox
                  v-model="relatedData.insert.taxon_list.is_private"
                  :value="true"
                  :unchecked-value="false"
                />
              </td>
              ...
              <td>
                <b-form-input
                  v-model="relatedData.insert.taxon_list.remarks"
                  type="text"
                />
              </td>

      ...
      <div class="table-responsive-sm">
        <table class="table table-hover table-bordered">
          ...
          <tr v-for="(entity, index) in relatedData.analysis"
            ...
            <!-- VIEW MODE -->
            <td v-if="!entity.editMode" v-translate="{et: entity.analysis_method__analysis_method, en: entity.analysis_method__method_en}"></td>
          ...
          <tr class="related-input-data">
            ...
            <td class="text-center">
              <b-form-checkbox v-model="relatedData.insert.analysis.is_private" :value="true" :unchecked-value="false"/>
            </td>

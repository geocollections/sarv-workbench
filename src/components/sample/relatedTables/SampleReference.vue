<template>
  <div
    ...
    :class="{ active: activeTab === 'sample_reference' }"
    role="tabpanel"
  >
    <div class="col-sm-12" v-if="activeTab === 'sample_reference'">
      <div class="table-responsive-sm">
        <table class="table table-hover table-bordered  related-table">
          ...
          <tbody>
            <tr
              v-for="(entity, index) in relatedData.sample_reference"
              :key="entity.id"
              :class="{
            ...
            <tr class="related-input-data">
              <td>
                <vue-multiselect
                  v-model="relatedData.insert.sample_reference.reference"
                  id="reference_insert"
                  label="reference"
                  track-by="id"
                  :placeholder="$t('add.inputs.autocomplete')"
              ...
              <td>
                <b-form-input
                  v-model="relatedData.insert.sample_reference.remarks"
                  type="text"
                />
              </td>

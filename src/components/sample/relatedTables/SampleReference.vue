<template>
  <div id="#tab-reference" class="tab-reference row" :class="{active: activeTab === 'sample_reference'}"
       role="tabpanel">
      ...
      <div class="table-responsive-sm">
        <table class="table table-hover table-bordered  related-table">
          ...
          <tr class="related-input-data">
            <td>
              <vue-multiselect v-model="relatedData.insert.sample_reference.reference"
                               id="reference_insert"
                               label="reference"
                               track-by="id"
                               :placeholder="$t('add.inputs.autocomplete')"

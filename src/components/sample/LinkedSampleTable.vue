            ...
            <tr>
              ...
              <th class="p-0">
                <b-form-input
                  autocomplete="off"
                  class="col-sm-8 mw-100"
                  v-model="searchParameters.number"
                  type="text"
                ></b-form-input>
              </th>
              <th class="p-0">
                <b-form-input
                  autocomplete="off"
                  class="col-sm-8 mw-100"
                  v-model="searchParameters.depth"
                  type="text"
                ></b-form-input>
              </th>
              <th class="p-0">
                <b-form-input
                  autocomplete="off"
                  class="col-sm-8 mw-100"
                  v-model="searchParameters.depth_interval"
                  type="text"
                ></b-form-input>
              </th>
              <th class="p-0">
                <b-form-input
                  autocomplete="off"
                  class="col-sm-8 mw-100"
                  v-model="searchParameters.stratigraphy"
                  type="text"
                ></b-form-input>
              </th>
              <th class="p-0">
                <b-form-input
                  autocomplete="off"
                  class="col-sm-8 mw-100"
                  v-model="searchParameters.lithostratigraphy"
                  type="text"
                ></b-form-input>
              </th>
              <th class="p-0">
              ...
              <td colspan="7" class="text-center">
                <div class="d-flex justify-content-center">
                  ...
                  <div
                    ...
                    @click="setDefaultSearchParameters"
                    title="Reset search"
                  >
  ...
  methods: {
    loadLinkedSamples() {
      fetchLinkedSamples(this.searchParameters, this.siteID).then(response => {
        ...
        this.sample_results = response.body.results

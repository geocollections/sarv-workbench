    ...
    <div class="col-sm-12" v-if="activeTab === 'locality_stratigraphy'">
      <div class="table-responsive-sm">
        <table class="table table-hover table-bordered  related-table">
          ...
          <tbody>
            <tr
              v-for="(entity, index) in relatedData.locality_stratigraphy"
              :key="entity.id"
              :class="{
            ...
            <tr class="related-input-data">
              <td>
                <vue-multiselect
                  v-model="
                    relatedData.insert.locality_stratigraphy.stratigraphy
                  "
              ...
              <td>
                <b-form-input
                  v-model="relatedData.insert.locality_stratigraphy.depth_base"
                  type="text"
                />
              </td>
              ...
              <td>
                <b-form-input
                  v-model="relatedData.insert.locality_stratigraphy.depth_top"
                  type="text"
                />
              </td>
              ...
              <td>
                <vue-multiselect
                  v-model="relatedData.insert.locality_stratigraphy.reference"
                  id="reference_insert"
                  label="reference"
                  track-by="id"
                  :placeholder="$t('add.inputs.autocomplete')"
              ...
              <td>
                <vue-multiselect
                  v-model="relatedData.insert.locality_stratigraphy.agent"
                  id="agent_insert"
                  label="agent"
                  track-by="id"
                  :placeholder="$t('add.inputs.autocomplete')"
              ...
              <td>
                <b-form-input
                  v-model="relatedData.insert.locality_stratigraphy.year"
                  type="text"
                />
              </td>
              ...
              <td class="text-center">
                <b-form-checkbox
                  id="is_current"
                  v-model="relatedData.insert.locality_stratigraphy.current"
                  :value="true"
                  :unchecked-value="false"
                >
                </b-form-checkbox>

<template>
  <div
    id="#tab-synonym"
    class="tab-pane row"
    :class="{ active: activeTab === 'locality_synonym' }"
    role="tabpanel"
  >
    <div class="col-sm-12" v-if="activeTab === 'locality_synonym'">
      <div class="table-responsive-sm">
        <table class="table table-hover table-bordered related-table">
          ...
          <tbody>
            <tr
              v-for="(entity, index) in relatedData.locality_synonym"
              :key="entity.id"
              :class="{
            ...
            <tr class="related-input-data">
              <td>
                <b-form-input
                  v-model="relatedData.insert.locality_synonym.synonym"
                  type="text"
                />
              </td>
              ...
              <td>
                <vue-multiselect
                  v-model="relatedData.insert.locality_synonym.reference"
                  id="reference_insert"
                  label="reference"
                  track-by="id"
                  :placeholder="$t('add.inputs.autocomplete')"
              ...
              <td>
                <b-form-input
                  v-model="relatedData.insert.locality_synonym.pages"
                  type="text"
                />
              </td>
              ...
              <td style="min-width: 20em;">
                <b-form-input
                  v-model="relatedData.insert.locality_synonym.remarks"
                  type="text"
                />
              </td>

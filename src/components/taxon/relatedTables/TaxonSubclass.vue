<template>
  <div
    class="taxon-subclass row"
    :class="{ active: activeTab === 'taxon_subclass' }"
  >
    <div class="col-sm-12" v-if="activeTab === 'taxon_subclass'">
        ...
        <table class="table table-hover table-bordered related-table">
          ...
          <tbody>
            ...
            >
              ...
              <td v-if="!entity.editMode">{{ entity.author_year }}</td>
              ...
              <td v-if="entity.editMode">
                <b-form-input v-model="entity.new.author_year" type="text" />
              </td>
            ...
            <tr class="related-input-data">
              <td>
                <vue-multiselect
                  v-model="relatedData.insert.taxon_subclass.taxon"
                  id="taxon_insert"
                  label="taxon"
                  track-by="id"
                  :placeholder="$t('add.inputs.autocomplete')"
              ...
              <td>
                <b-form-input
                  v-model="relatedData.insert.taxon_subclass.author_year"
                  type="text"
                />
              </td>
              ...
              <td>
                <b-form-input
                  v-model="relatedData.insert.taxon_subclass.remarks"
                  type="text"
                />
              </td>

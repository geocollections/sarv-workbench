    ...
    <div class="col-sm-12" v-if="activeTab === 'specimen_history'">
      <div class="table-responsive-sm">
        <table class="table table-hover related-table">
          ...
          <tbody>
            <tr
              v-for="(entity, index) in relatedData.specimen_history"
              :key="entity.id"
              :class="{
            ...
            <tr class="related-input-data">
              <td>
                <vue-multiselect
                  v-model="relatedData.insert.specimen_history.type"
                  id="type_insert"
                  :options="autocomplete.list_history_type"
                  track-by="id"
                  :label="commonLabel"
              ...
              <td>
                <b-form-input
                  size="sm"
                  v-model="relatedData.insert.specimen_history.value_old"
                  type="text"
                />
              </td>
              ...
              <td>
                <b-form-input
                  size="sm"
                  v-model="relatedData.insert.specimen_history.value_new"
                  type="text"
                />
              </td>
              ...
              <td>
                <b-form-input
                  size="sm"
                  v-model="relatedData.insert.specimen_history.remarks"
                  type="text"
                />
              </td>

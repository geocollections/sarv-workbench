    ...
    <div class="col-sm-12" v-if="activeTab === 'specimen_description'">
      <div class="table-responsive-sm">
        <table class="table table-hover related-table">
          ...
          <tbody>
            <tr
              v-for="(entity, index) in relatedData.specimen_description"
              :key="entity.id"
              :class="{
            ...
            >
              ...
              <td v-if="!entity.editMode">
                <span
                  v-translate="{
                    et: entity.unit__value,
                    en: entity.unit__value_en
                  }"
                ></span>
              </td>
              ...
              <td v-if="entity.editMode">
                <b-form-input
                  size="sm"
                  v-model="entity.new.description"
                  type="text"
                />
              </td>
            ...
            <tr class="related-input-data">
              <td>
                <b-form-input
                  size="sm"
                  v-model="relatedData.insert.specimen_description.length"
                  type="number"
                />
              </td>
              ...
              <td>
                <b-form-input
                  size="sm"
                  v-model="relatedData.insert.specimen_description.width"
                  type="number"
                />
              </td>
              ...
              <td>
                <b-form-input
                  size="sm"
                  v-model="relatedData.insert.specimen_description.height"
                  type="number"
                />
              </td>
              ...
              <td>
                <vue-multiselect
                  v-model="relatedData.insert.specimen_description.unit"
                  id="unit_insert"
                  :options="autocomplete.list_unit"
                  track-by="id"
                  :label="commonLabel"
              ...
              <td>
                <b-form-input
                  size="sm"
                  v-model="relatedData.insert.specimen_description.mass"
                  type="number"
                  step="0.1"
                />
              </td>
              ...
              <td>
                <b-form-input
                  size="sm"
                  v-model="relatedData.insert.specimen_description.description"
                  type="text"
                />
              </td>
              ...
              <td>
                <vue-multiselect
                  v-model="relatedData.insert.specimen_description.agent"
                  id="agent_insert"
                  label="agent"
                  track-by="id"
                  :placeholder="$t('add.inputs.autocomplete')"
              ...
              <td>
                <b-form-input
                  size="sm"
                  v-model="relatedData.insert.specimen_description.remarks"
                  type="text"
                />
              </td>

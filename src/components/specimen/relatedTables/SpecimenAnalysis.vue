          ...
          <tbody>
            ...
            >
              ...
              <td v-if="!entity.editMode">
                ...
                <span
                  v-if="
                    entity.analysis_method__analysis_method ||
                      entity.analysis_method__method_en
                  "
                  v-translate="{
              ...
              <td v-if="entity.editMode">
                <b-form-input
                  size="sm"
                  v-model="entity.new.method_details"
                  type="text"
                />
              </td>
            ...
            <tr class="related-input-data">
              ...
              <td>
                <vue-multiselect
                  v-model="relatedData.insert.analysis.storage"
                  id="storage_insert"
                  label="location"
                  track-by="id"
                  :placeholder="$t('add.inputs.autocomplete')"

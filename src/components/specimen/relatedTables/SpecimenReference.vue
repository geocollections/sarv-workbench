    ...
    <div class="col-sm-12" v-if="activeTab === 'specimen_reference'">
      <div class="table-responsive-sm">
        <table class="table table-hover related-table">
          ...
          <tbody>
            <tr
              v-for="(entity, index) in relatedData.specimen_reference"
              :key="entity.id"
              :class="{
            ...
            <tr class="related-input-data">
              <td>
                <vue-multiselect
                  v-model="relatedData.insert.specimen_reference.reference"
                  id="reference_insert"
                  label="reference"
                  track-by="id"
                  :placeholder="$t('add.inputs.autocomplete')"
              ...
              <td>
                <b-form-input
                  size="sm"
                  v-model="relatedData.insert.specimen_reference.pages"
                  type="text"
                />
              </td>
              ...
              <td>
                <b-form-input
                  size="sm"
                  v-model="relatedData.insert.specimen_reference.figures"
                  type="text"
                />
              </td>
              ...
              <td>
                <b-form-input
                  size="sm"
                  v-model="relatedData.insert.specimen_reference.remarks"
                  type="text"
                />
              </td>

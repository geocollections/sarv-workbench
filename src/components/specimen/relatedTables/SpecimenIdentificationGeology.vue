<template>
  <div
    class="tab-identification-geology row"
    :class="{ active: activeTab === 'specimen_identification_geology' }"
  >
    <div
      class="col-sm-12"
      v-if="activeTab === 'specimen_identification_geology'"
    >
      <div class="table-responsive-sm">
        <table class="table table-hover related-table">
          ...
          <tbody>
            <tr
              v-for="(entity,
              index) in relatedData.specimen_identification_geology"
              :key="entity.id"
              :class="{
            ...
            >
              ...
              <td v-if="!entity.editMode">
                <span
                  v-translate="{
                    et: entity.rock__name,
                    en: entity.rock__name_en
                  }"
                ></span>
              </td>
            ...
            <tr class="related-input-data">
              <td>
                <vue-multiselect
                  v-model="
                    relatedData.insert.specimen_identification_geology.rock
                  "
                  id="rock_insert"
                  :label="nameLabel"
                  track-by="id"
              ...
              <td>
                <b-form-input
                  size="sm"
                  v-model="
                    relatedData.insert.specimen_identification_geology.name
                  "
                  type="text"
                />
              </td>
              ...
              <td>
                <b-form-input
                  size="sm"
                  v-model="
                    relatedData.insert.specimen_identification_geology.name_en
                  "
                  type="text"
                />
              </td>
              ...
              <td>
                <vue-multiselect
                  v-model="
                    relatedData.insert.specimen_identification_geology.agent
                  "
                  id="agent_insert"
                  label="agent"
                  track-by="id"
              ...
              <td>
                <vue-multiselect
                  v-model="
                    relatedData.insert.specimen_identification_geology.reference
                  "
                  id="reference_insert"
                  label="reference"
                  track-by="id"
              ...
              <td>
                <datepicker
                  ...
                  input-class="form-control form-control-sm"
                  v-model="
                    relatedData.insert.specimen_identification_geology
                      .date_identified
                  "
                  lang="en"
                  :first-day-of-week="1"
              ...
              <td>
                <vue-multiselect
                  v-model="
                    relatedData.insert.specimen_identification_geology.type
                  "
                  id="type_insert"
                  :options="autocomplete.list_identification_type"
                  track-by="id"
              ...
              <td>
                <v-checkbox
                  id="current_insert"
                  v-model="
                    relatedData.insert.specimen_identification_geology.current
                  "
                  hide-details
                  class="mt-0 justify-center"
                  :ripple="false"

...
<!--      <vs-sidebar-group v-if="permissions.site" :title="$t('header.sites')">-->
      ...
      <vs-sidebar-group v-if="permissions.attachment" :title="$t('header.files')">
        <vs-sidebar-item index="4.1" icon="fa-folder" icon-pack="far" :to="{ path: '/attachment' }">
          {{ $t('frontPage.buttons.myFiles') }}
        </vs-sidebar-item>
        <vs-sidebar-item index="4.2" icon="fa-image" icon-pack="far" :to="{ path: '/attachment/add/photo_archive' }">
          {{ $t('frontPage.buttons.photoArchive') }}
        </vs-sidebar-item>
        <vs-sidebar-item index="4.3" icon="fa-image" icon-pack="fas" :to="{ path: '/attachment/add/specimen_image' }">
          {{ $t('frontPage.buttons.specimenImage') }}
        </vs-sidebar-item>
        <vs-sidebar-item index="4.4" icon="fa-file" icon-pack="far" :to="{ path: '/attachment/add/other_file' }">
          {{ $t('frontPage.buttons.otherFiles') }}
        </vs-sidebar-item>
        <vs-sidebar-item index="4.5" icon="fa-file-pdf" icon-pack="far" :to="{ path: '/attachment/add/digitised_reference' }">
          {{ $t('frontPage.buttons.digitisedReference') }}
        </vs-sidebar-item>
      </vs-sidebar-group>

<!--      <vs-sidebar-group v-if="permissions.imageset" :title="$t('header.imagesets')">-->
      <vs-sidebar-group :title="$t('header.imagesets')">
        <vs-sidebar-item index="5.1" icon="fa-images" icon-pack="far" :to="{ path: '/imageset/add' }">
          {{ $t('frontPage.buttons.imageset') }}
        </vs-sidebar-item>
      </vs-sidebar-group>

<!--      <vs-sidebar-group v-if="permissions.journal" :title="$t('header.journals')">-->
      <vs-sidebar-group :title="$t('header.journals')">
        <vs-sidebar-item index="5.1" icon="fa-newspaper" icon-pack="far" :to="{ path: '/journal/add' }">
          {{ $t('frontPage.buttons.journal') }}
        </vs-sidebar-item>
      </vs-sidebar-group>

      <vs-sidebar-group v-if="permissions.reference" :title="$t('header.references')">
        <vs-sidebar-item index="6.1" icon="fa-book" icon-pack="fas" :to="{ path: '/reference' }">
          {{ $t('frontPage.buttons.myReferences') }}
        </vs-sidebar-item>
        <vs-sidebar-item index="6.2" icon="fa-book-open" icon-pack="fas" :to="{ path: '/reference/add' }">
          {{ $t('frontPage.buttons.reference') }}
        </vs-sidebar-item>
      </vs-sidebar-group>

      <vs-sidebar-group v-if="permissions.library" :title="$t('header.libraries')">
        <vs-sidebar-item index="7.1" icon="fa-list-alt" icon-pack="far" :to="{ path: '/library' }">
          {{ $t('frontPage.buttons.libraries') }}
        </vs-sidebar-item>
        <vs-sidebar-item index="7.2" icon="fa-edit" icon-pack="far" :to="{ path: '/library/add' }">

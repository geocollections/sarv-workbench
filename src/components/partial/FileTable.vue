  ...
  <div class="d-flex flex-wrap align-items-center">
    ...
    >
      ...
      <div
        ...
        @click="
          openUrlInNewWindow({
            url: composeFileUrl(file[prefix + 'uuid_filename'], 'original')
          })
        "
      ...
      >
        ...
        <audio
          v-if="
            file[prefix + 'uuid_filename'] &&
              ['mp3', 'wav'].indexOf(
                file[prefix + 'uuid_filename'].split('.')[1]
              ) > -1
          "
          controls
        >
          <source
            :src="composeFileUrl(file[prefix + 'uuid_filename'], 'original')"
            :type="file.attachment_format__value"
          />
        ...
        <video
          v-else-if="
            file[prefix + 'uuid_filename'] &&
              ['mp4'].indexOf(file[prefix + 'uuid_filename'].split('.')[1]) > -1
          "
          type="video"
        ...
        <i
          v-else-if="
            file[prefix + 'uuid_filename'] &&
              ['pdf'].indexOf(file[prefix + 'uuid_filename'].split('.')[1]) > -1
          "

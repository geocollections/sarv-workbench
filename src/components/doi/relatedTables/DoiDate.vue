    ...
    <div class="col-sm-12" v-if="activeTab === 'doi_date'">
      <div class="table-responsive-sm">
        <table class="table table-hover table-bordered  related-table">
          ...
          <tbody>
            <tr
              v-for="(entity, index) in relatedData.doi_date"
              :key="entity.id"
              :class="{
            ...
            <tr class="related-input-data">
              <td>
                <b-form-input
                  v-model="relatedData.insert.doi_date.date"
                  type="text"
                />
              </td>
              ...
              <td>
                <vue-multiselect
                  v-model="relatedData.insert.doi_date.date_type"
                  id="date_type_insert"
                  :options="autocomplete.doi_date_type"
                  track-by="id"
                  label="value"
              ...
              <td>
                <b-form-input
                  v-model="relatedData.insert.doi_date.remarks"
                  type="text"
                />
              </td>

    ...
    <div class="col-sm-12" v-if="activeTab === 'doi_related_identifier'">
      <div class="table-responsive-sm">
        <table class="table table-hover table-bordered  related-table">
          ...
          <tbody>
            <tr
              v-for="(entity, index) in relatedData.doi_related_identifier"
              :key="entity.id"
              :class="{
            ...
            >
              ...
              <td v-if="entity.editMode">
                <vue-multiselect
                  v-model="entity.new.identifier_type"
                  id="identifier_type"
              ...
              <td v-if="entity.editMode">
                <vue-multiselect
                  v-model="entity.new.relation_type"
                  id="relation_type"
            ...
            <tr class="related-input-data">
              <td>
                <vue-multiselect
                  v-model="
                    relatedData.insert.doi_related_identifier.identifier_type
                  "
              ...
              <td>
                <vue-multiselect
                  v-model="
                    relatedData.insert.doi_related_identifier.relation_type
                  "
              ...
              <td>
                <b-form-input
                  v-model="relatedData.insert.doi_related_identifier.value"
                  type="text"
                />
              </td>
              ...
              <td>
                <b-form-input
                  v-model="relatedData.insert.doi_related_identifier.remarks"
                  type="text"
                />
              </td>

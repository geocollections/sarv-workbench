  ...
  <div v-if="data.length > 0">
    <div class="list" v-for="(entity, index) in data">
      ...
      <div class="list-row ml-2 p-1">
        ...
        <span>
              <a v-if="entity.attachment__filename" class="green-link" href="javascript:void(0)"
                 @click="openPdf({pdf: entity.attachment__filename})">
                <b>PDF</b>
              </a>
              <a v-if="entity.attachment__filename === null && entity.url" class="red-link" :href="entity.url"

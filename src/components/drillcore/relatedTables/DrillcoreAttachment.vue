<template>
  <div
    class="drillcore-attachment tab-attachment row"
  ...
  >
    <div class="col-md-6" v-if="activeTab === 'attachment'">
      <div class="table-responsive-sm">
        <table class="table table-hover related-table">
          ...
          <tbody>
            <tr
              v-for="(entity, index) in relatedData.attachment"
              :key="entity.id"
              :class="{
            ...
            <tr class="related-input-data">
              <td>
                <vue-multiselect
                  v-model="relatedData.insert.attachment.attachment"
              ...
              <td>
                <b-form-input
                  size="sm"
                  v-model="relatedData.insert.attachment.remarks"
                  type="text"
                />
              </td>
    ...
    <div
      class="col-md-6"
      v-if="activeTab === 'attachment' && $route.meta.isEdit"
    >
      <file-table
